...
public class PehkuiEntitySelectorOptions {
	public static final Text SCALE_RANGE_DESCRIPTION =
		I18nUtils.translate("argument.entity.options." + Pehkui.MOD_ID + ".scale_range.description",
			"Entities with scale value");
	public static final Text SCALE_TYPE_DESCRIPTION =
		I18nUtils.translate("argument.entity.options." + Pehkui.MOD_ID + ".scale_type.description",
			"Entities with scale type");
	public static final Text SCALE_NBT_DESCRIPTION =
		I18nUtils.translate("argument.entity.options." + Pehkui.MOD_ID + ".scale_nbt.description",
			"Entities with scale NBT");
